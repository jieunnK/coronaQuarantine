...
<%
    ...
    String pagenumber = request.getParameter("page"); //eateryfumigatorList.jsp?pg=?
    ...
    ArrayList<EateryfumigatorDTO> eateryfumigatorList = eateryfumigatorDAO.pageQuery(fromBoard, toBoard);
    
    int total = eateryfumigatorDAO.eaterygetCount(); //총 게시물 수
