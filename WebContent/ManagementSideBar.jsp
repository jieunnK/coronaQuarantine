...
<div id="page-wrapper">
	...
	<div id="sidebar-wrapper">
		<ul class="sidebar-nav">
			<li class="sidebar-brand"><a>관리페이지 검색</a></li>

			<form name="SeleteForm" action="./ManagementSearch.jsp" method="post">
				<ul>
					<li>
						<a>조건 검색 
					...
					<li>
						<a><input name="categorymemo" type="text" style="text-align: center; width: 200px; height: 30px;" value="<%=categorymemo%>"></a>
					</li>
					<li>
						<a>업종 &nbsp;&nbsp;&nbsp; 
					...
					<li><a>~ </a></li>
					<li><a><input type="date" id="start" name="tripclose" value="<%=tripclose%>" min="2020-01-01" max="2030-12-31"></a></li>
					<li>
						<a>
							<input type="submit" class="btn btn-secondary" value="검색">
							 &nbsp;&nbsp;&nbsp; 
							 <input type="button" class="btn btn-secondary" value="전체 검색" onClick="location.href='/Management.jsp'">
						</a>
					</li>
				</ul>
			</form>
