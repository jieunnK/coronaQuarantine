			...
			<tbody>
				...
				<tr>
					...
					if (fileList != null) 
					{
						...
						{
							%>
							<img src="/upload/<%=fileList.get(j).getFile_name()%>" width="100" height="80"> 
							<%
					 	}
					 }
					 %>
				...
				<tr>
					<td>
						<input class="btn btn-secondary" type=button name=change value='뒤로가기' onclick="javascript:history.back();">
					</td>
				</tr>
			</tbody>
		</table>
